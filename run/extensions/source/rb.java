 ...
 * use of the "rb" extension. When possible, the file provenance author
 ...
 */
public class rb extends FileExtension{
    /**
    ...
    public String getDescription() {
        return "Ruby script"; // file type description
    }
