 ...
 * use of the "php" extension. When possible, the file provenance author
 ...
 */
public class php extends FileExtension{
    /**
    ...
    public FileLanguage getLanguage(){
        return FileLanguage.PHP; // to which language is the file more related?
    }
