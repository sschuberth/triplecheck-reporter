 ...
 * Created: 2014-04-09T21:46:41Z
 * LicenseName: EUPL-1.1-without-appendix
 * FileName: obj.java  
 * FileCategory: SOURCE
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> This class provides details about the files that make 
 * use of the "obj" extension. When possible, the file provenance author
 ...
 */
public class obj extends FileExtension{
    /**
    ...
    public String getDescription() {
        return "Object code file (Intel Relocatable Object Module)"; // file type description
    }
