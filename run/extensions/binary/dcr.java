 ...
 * Created: 2014-04-09T21:46:32Z
 * LicenseName: EUPL-1.1-without-appendix
 * FileName: dcr.java  
 * FileCategory: SOURCE
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> This class provides details about the files that make 
 * use of the "dcr" extension. When possible, the file provenance author
 ...
 */
public class dcr extends FileExtension{
    /**
    ...
    public String getDescription() {
        return "Delphi Component Resource"; // file type description
    }
