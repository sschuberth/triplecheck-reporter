 ...
 * use of the "prefs" extension. When possible, the file provenance author
 ...
 */
public class prefs extends FileExtension{
    /**
    ...
    public String getDescription() {
        return "Eclipse project settings file"; // file type description
    }
    ...
    public FileLanguage getLanguage(){
        // the most typical languages where Eclipse IDE is used
        languages.add(FileLanguage.JAVA);
        languages.add(FileLanguage.PHP);
