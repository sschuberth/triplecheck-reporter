 ...
 * Created: 2014-04-04T16:13:19Z
 * LicenseName: CC-BY-4.0
 * FileName: cproject.java  
 * FileCategory: SOURCE
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> This class provides details about the files that make 
 * use of the "cproject" extension. When possible, the file provenance author
 ...
 */
public class cproject extends FileExtension{
    /**
    ...
    public String getDescription() {
        return "Settings specific to an Eclipse CDT project"; // file type description
    }
