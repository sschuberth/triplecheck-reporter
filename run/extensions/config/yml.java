 ...
 * use of the "yml" extension. When possible, the file provenance author
 ...
 */
public class yml extends FileExtension{
    /**
    ...
    public String getDescription() {
        return "YAML (YAML Ain't Markup Language) data file"; // file type description
    }
    ...
    public FileLanguage getLanguage(){
        // wikipedia refers every possible language, we add here just a subset
        languages.add(FileLanguage.JAVASCRIPT);
        languages.add(FileLanguage.PERL);
        languages.add(FileLanguage.PYTHON);
        languages.add(FileLanguage.RUBY);
