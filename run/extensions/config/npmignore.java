 ...
 * use of the "npmignore" extension. When possible, the file provenance author
 ...
 */
public class npmignore extends FileExtension{
    /**
    ...
    public String getDescription() {
        return "File from Node.js package manager"; // file type description
    }
    ...
    public FileLanguage getLanguage(){
        // no doubts that this kind of file is only used by NODE.js
