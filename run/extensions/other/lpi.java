 ...
 * Created: 2014-04-09T21:46:18Z
 * LicenseName: EUPL-1.1-without-appendix
 * FileName: lpi.java  
 * FileCategory: SOURCE
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> This class provides details about the files that make 
 * use of the "lpi" extension. When possible, the file provenance author
 ...
 */
public class lpi extends FileExtension{
    /**
    ...
    public String getDescription() {
        return "Free Pascal Lazarus project information file"; // file type description
    }
    ...
    public FileCategory getCategory() {
        return FileCategory.OTHER; // does it group under a category?
    }
