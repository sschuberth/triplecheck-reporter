 ...
 * Created: 2014-04-09T21:46:38Z
 * LicenseName: EUPL-1.1-without-appendix
 * FileName: lrs.java  
 * FileCategory: SOURCE
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> This class provides details about the files that make 
 * use of the "lrs" extension. When possible, the file provenance author
 ...
 */
public class lrs extends FileExtension{
    /**
    ...
    public String getDescription() {
        return "Language resource file"; // file type description
    }
