 ...
 * Created: 2014-04-09T21:46:20Z
 * LicenseName: EUPL-1.1-without-appendix
 * FileName: lpr.java  
 * FileCategory: SOURCE
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> This class provides details about the files that make 
 * use of the "lpr" extension. When possible, the file provenance author
 ...
 */
public class lpr extends FileExtension{
    /**
    ...
    public String getDescription() {
        return "Lazarus project file"; // file type description
    }
