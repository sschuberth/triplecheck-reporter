 ...
 * FileName: dirname-handles-absolute-path.java  
 * FileCategory: SOURCE
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> This class provides details about the files that make 
 * use of the "dirname-handles-absolute-path" extension. When possible, the file provenance author
 ...
 */
public class ext_path extends FileExtension{
    /**
    ...
    public String getIdentifierShort() {
        return "dirname-handles-absolute-path";
    }
