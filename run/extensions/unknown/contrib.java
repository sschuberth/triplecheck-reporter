 ...
 * Created: 2014-04-09T18:25:18Z
 * LicenseName: EUPL-1.1-without-appendix
 * FileName: contrib.java  
 * FileCategory: SOURCE
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> This class provides details about the files that make 
 * use of the "contrib" extension. When possible, the file provenance author
 ...
 */
public class contrib extends FileExtension{
    /**
