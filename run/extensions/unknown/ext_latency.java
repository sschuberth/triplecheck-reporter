 ...
 * FileName: sysfs-cfq-target-latency.java  
 * FileCategory: SOURCE
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> This class provides details about the files that make 
 * use of the "sysfs-cfq-target-latency" extension. When possible, the file provenance author
 ...
 */
public class ext_latency extends FileExtension{
    /**
    ...
    public String getIdentifierShort() {
        return "sysfs-cfq-target-latency";
    }
