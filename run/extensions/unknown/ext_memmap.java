 ...
 * FileName: sysfs-firmware-memmap.java  
 * FileCategory: SOURCE
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> This class provides details about the files that make 
 * use of the "sysfs-firmware-memmap" extension. When possible, the file provenance author
 ...
 */
public class ext_memmap extends FileExtension{
    /**
