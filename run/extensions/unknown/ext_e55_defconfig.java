 ...
 * FileName: e55_defconfig.java  
 * FileCategory: SOURCE
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> This class provides details about the files that make 
 * use of the "e55_defconfig" extension. When possible, the file provenance author
 ...
 */
public class ext_e55_defconfig extends FileExtension{
    /**
