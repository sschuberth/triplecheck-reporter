 ...
 * FileName: test-record-branch-filter-k.java  
 * FileCategory: SOURCE
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> This class provides details about the files that make 
 * use of the "test-record-branch-filter-k" extension. When possible, the file provenance author
 ...
 */
public class ext_k extends FileExtension{
    /**
    ...
    public String getIdentifierShort() {
        return "test-record-branch-filter-k";
    }
