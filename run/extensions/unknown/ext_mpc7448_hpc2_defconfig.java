 ...
 * Created: 2014-05-14T19:37:51Z
 * LicenseName: EUPL-1.1-without-appendix
 * FileName: mpc7448_hpc2_defconfig.java  
 * FileCategory: SOURCE
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> This class provides details about the files that make 
 * use of the "mpc7448_hpc2_defconfig" extension. When possible, the file provenance author
 ...
 */
public class ext_mpc7448_hpc2_defconfig extends FileExtension{
    /**
