 ...
 * Created: 2014-04-09T18:25:35Z
 * LicenseName: EUPL-1.1-without-appendix
 * FileName: riscos.java  
 * FileCategory: SOURCE
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> This class provides details about the files that make 
 * use of the "riscos" extension. When possible, the file provenance author
 ...
 */
public class riscos extends FileExtension{
    /**
