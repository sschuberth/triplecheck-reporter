 ...
 * FileName: test-record-period.java  
 * FileCategory: SOURCE
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> This class provides details about the files that make 
 * use of the "test-record-period" extension. When possible, the file provenance author
 ...
 */
public class ext_period extends FileExtension{
    /**
