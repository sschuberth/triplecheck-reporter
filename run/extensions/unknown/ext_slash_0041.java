 ...
 * FileName: echo-prints-slash_0041.java  
 * FileCategory: SOURCE
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> This class provides details about the files that make 
 * use of the "echo-prints-slash_0041" extension. When possible, the file provenance author
 ...
 */
public class ext_slash_0041 extends FileExtension{
    /**
