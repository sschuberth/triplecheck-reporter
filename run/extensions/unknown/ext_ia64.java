 ...
 * FileName: makefile-ia64.java  
 * FileCategory: SOURCE
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> This class provides details about the files that make 
 * use of the "makefile-ia64" extension. When possible, the file provenance author
 ...
 */
public class ext_ia64 extends FileExtension{
    /**
