 ...
 * FileName: sh7724_generic_defconfig.java  
 * FileCategory: SOURCE
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> This class provides details about the files that make 
 * use of the "sh7724_generic_defconfig" extension. When possible, the file provenance author
 ...
 */
public class ext_sh7724_generic_defconfig extends FileExtension{
    /**
    ...
    public String getIdentifierShort() {
        return "sh7724_generic_defconfig";
    }
