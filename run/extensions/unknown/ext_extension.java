 ...
 * FileName: basename-does-not-remove-identical-extension.java  
 * FileCategory: SOURCE
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> This class provides details about the files that make 
 * use of the "basename-does-not-remove-identical-extension" extension. When possible, the file provenance author
 ...
 */
public class ext_extension extends FileExtension{
    /**
    ...
    public String getIdentifierShort() {
        return "basename-does-not-remove-identical-extension";
    }
