 ...
 * FileName: fam15h_power.java  
 * FileCategory: SOURCE
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> This class provides details about the files that make 
 * use of the "fam15h_power" extension. When possible, the file provenance author
 ...
 */
public class ext_fam15h_power extends FileExtension{
    /**
