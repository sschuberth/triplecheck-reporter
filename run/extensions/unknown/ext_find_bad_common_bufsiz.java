 ...
 * FileName: find_bad_common_bufsiz.java  
 * FileCategory: SOURCE
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> This class provides details about the files that make 
 * use of the "find_bad_common_bufsiz" extension. When possible, the file provenance author
 ...
 */
public class ext_find_bad_common_bufsiz extends FileExtension{
    /**
