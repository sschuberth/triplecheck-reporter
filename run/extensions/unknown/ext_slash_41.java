 ...
 * FileName: echo-prints-slash_41.java  
 * FileCategory: SOURCE
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> This class provides details about the files that make 
 * use of the "echo-prints-slash_41" extension. When possible, the file provenance author
 ...
 */
public class ext_slash_41 extends FileExtension{
    /**
