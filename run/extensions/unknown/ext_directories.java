 ...
 * FileName: mkdir-makes-parent-directories.java  
 * FileCategory: SOURCE
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> This class provides details about the files that make 
 * use of the "mkdir-makes-parent-directories" extension. When possible, the file provenance author
 ...
 */
public class ext_directories extends FileExtension{
    /**
    ...
    public String getIdentifierShort() {
        return "mkdir-makes-parent-directories";
    }
