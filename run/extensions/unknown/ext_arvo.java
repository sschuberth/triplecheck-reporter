 ...
 * FileName: sysfs-driver-hid-roccat-arvo.java  
 * FileCategory: SOURCE
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> This class provides details about the files that make 
 * use of the "sysfs-driver-hid-roccat-arvo" extension. When possible, the file provenance author
 ...
 */
public class ext_arvo extends FileExtension{
    /**
    ...
    public String getIdentifierShort() {
        return "sysfs-driver-hid-roccat-arvo";
    }
