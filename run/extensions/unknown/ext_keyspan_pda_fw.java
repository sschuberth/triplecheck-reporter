 ...
 * Created: 2014-05-14T19:43:51Z
 * LicenseName: EUPL-1.1-without-appendix
 * FileName: makefile-keyspan_pda_fw.java  
 * FileCategory: SOURCE
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> This class provides details about the files that make 
 * use of the "makefile-keyspan_pda_fw" extension. When possible, the file provenance author
 ...
 */
public class ext_keyspan_pda_fw extends FileExtension{
    /**
    ...
    public String getIdentifierShort() {
        return "makefile-keyspan_pda_fw";
    }
