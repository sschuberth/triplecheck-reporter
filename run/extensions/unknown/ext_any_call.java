 ...
 * Created: 2014-05-14T19:46:15Z
 * LicenseName: EUPL-1.1-without-appendix
 * FileName: test-record-branch-filter-any_call.java  
 * FileCategory: SOURCE
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> This class provides details about the files that make 
 * use of the "test-record-branch-filter-any_call" extension. When possible, the file provenance author
 ...
 */
public class ext_any_call extends FileExtension{
    /**
    ...
    public String getIdentifierShort() {
        return "test-record-branch-filter-any_call";
    }
