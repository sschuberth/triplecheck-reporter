 ...
 * FileName: armadillo800eva_defconfig.java  
 * FileCategory: SOURCE
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> This class provides details about the files that make 
 * use of the "armadillo800eva_defconfig" extension. When possible, the file provenance author
 ...
 */
public class ext_armadillo800eva_defconfig extends FileExtension{
    /**
    ...
    public String getIdentifierShort() {
        return "armadillo800eva_defconfig";
    }
