 ...
 * FileName: sysfs-platform-asus-wmi.java  
 * FileCategory: SOURCE
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> This class provides details about the files that make 
 * use of the "sysfs-platform-asus-wmi" extension. When possible, the file provenance author
 ...
 */
public class ext_wmi extends FileExtension{
    /**
    ...
    public String getIdentifierShort() {
        return "sysfs-platform-asus-wmi";
    }
