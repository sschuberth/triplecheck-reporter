 ...
 * Created: 2014-05-14T19:46:23Z
 * LicenseName: EUPL-1.1-without-appendix
 * FileName: p7-4-t-nh-sd-smp-hp-none.java  
 * FileCategory: SOURCE
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> This class provides details about the files that make 
 * use of the "p7-4-t-nh-sd-smp-hp-none" extension. When possible, the file provenance author
 ...
 */
public class ext_none extends FileExtension{
    /**
    ...
    public String getIdentifierShort() {
        return "p7-4-t-nh-sd-smp-hp-none";
    }
