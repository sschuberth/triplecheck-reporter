 ...
 * FileName: sysfs-devices-platform-sh_mobile_lcdc_fb.java  
 * FileCategory: SOURCE
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> This class provides details about the files that make 
 * use of the "sysfs-devices-platform-sh_mobile_lcdc_fb" extension. When possible, the file provenance author
 ...
 */
public class ext_sh_mobile_lcdc_fb extends FileExtension{
    /**
    ...
    public String getIdentifierShort() {
        return "sysfs-devices-platform-sh_mobile_lcdc_fb";
    }
