 ...
 * FileName: sysfs-driver-hid-lenovo-tpkbd.java  
 * FileCategory: SOURCE
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> This class provides details about the files that make 
 * use of the "sysfs-driver-hid-lenovo-tpkbd" extension. When possible, the file provenance author
 ...
 */
public class ext_tpkbd extends FileExtension{
    /**
    ...
    public String getIdentifierShort() {
        return "sysfs-driver-hid-lenovo-tpkbd";
    }
