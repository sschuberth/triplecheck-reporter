 ...
 * FileName: cp-a-preserves-links.java  
 * FileCategory: SOURCE
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> This class provides details about the files that make 
 * use of the "cp-a-preserves-links" extension. When possible, the file provenance author
 ...
 */
public class ext_links extends FileExtension{
    /**
