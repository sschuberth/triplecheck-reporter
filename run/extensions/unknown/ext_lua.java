 ...
 * FileName: sysfs-driver-hid-roccat-lua.java  
 * FileCategory: SOURCE
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> This class provides details about the files that make 
 * use of the "sysfs-driver-hid-roccat-lua" extension. When possible, the file provenance author
 ...
 */
public class ext_lua extends FileExtension{
    /**
    ...
    public String getIdentifierShort() {
        return "sysfs-driver-hid-roccat-lua";
    }
