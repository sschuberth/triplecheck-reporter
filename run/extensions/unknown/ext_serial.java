 ...
 * FileName: configfs-usb-gadget-serial.java  
 * FileCategory: SOURCE
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> This class provides details about the files that make 
 * use of the "configfs-usb-gadget-serial" extension. When possible, the file provenance author
 ...
 */
public class ext_serial extends FileExtension{
    /**
    ...
    public String getIdentifierShort() {
        return "configfs-usb-gadget-serial";
    }
