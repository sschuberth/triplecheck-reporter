 ...
 * FileName: failed-syscalls-report.java  
 * FileCategory: SOURCE
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> This class provides details about the files that make 
 * use of the "failed-syscalls-report" extension. When possible, the file provenance author
 ...
 */
public class ext_report extends FileExtension{
    /**
