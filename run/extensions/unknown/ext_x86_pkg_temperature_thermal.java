 ...
 * Created: 2014-05-14T19:39:41Z
 * LicenseName: EUPL-1.1-without-appendix
 * FileName: x86_pkg_temperature_thermal.java  
 * FileCategory: SOURCE
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> This class provides details about the files that make 
 * use of the "x86_pkg_temperature_thermal" extension. When possible, the file provenance author
 ...
 */
public class ext_x86_pkg_temperature_thermal extends FileExtension{
    /**
    ...
    public String getIdentifierShort() {
        return "x86_pkg_temperature_thermal";
    }
