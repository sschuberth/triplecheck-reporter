 ...
 * FileName: ap325rxa_defconfig.java  
 * FileCategory: SOURCE
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> This class provides details about the files that make 
 * use of the "ap325rxa_defconfig" extension. When possible, the file provenance author
 ...
 */
public class ext_ap325rxa_defconfig extends FileExtension{
    /**
