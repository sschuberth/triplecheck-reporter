 ...
 * Created: 2014-05-14T19:46:16Z
 * LicenseName: EUPL-1.1-without-appendix
 * FileName: test-record-group-sampling.java  
 * FileCategory: SOURCE
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> This class provides details about the files that make 
 * use of the "test-record-group-sampling" extension. When possible, the file provenance author
 ...
 */
public class ext_sampling extends FileExtension{
    /**
    ...
    public String getIdentifierShort() {
        return "test-record-group-sampling";
    }
