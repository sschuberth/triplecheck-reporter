 ...
 * FileName: colibri_pxa300_defconfig.java  
 * FileCategory: SOURCE
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> This class provides details about the files that make 
 * use of the "colibri_pxa300_defconfig" extension. When possible, the file provenance author
 ...
 */
public class ext_colibri_pxa300_defconfig extends FileExtension{
    /**
    ...
    public String getIdentifierShort() {
        return "colibri_pxa300_defconfig";
    }
