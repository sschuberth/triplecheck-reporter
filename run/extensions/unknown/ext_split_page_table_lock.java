 ...
 * Created: 2014-05-14T19:39:45Z
 * LicenseName: EUPL-1.1-without-appendix
 * FileName: split_page_table_lock.java  
 * FileCategory: SOURCE
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> This class provides details about the files that make 
 * use of the "split_page_table_lock" extension. When possible, the file provenance author
 ...
 */
public class ext_split_page_table_lock extends FileExtension{
    /**
