 ...
 * FileName: sysfs-kernel-boot_params.java  
 * FileCategory: SOURCE
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> This class provides details about the files that make 
 * use of the "sysfs-kernel-boot_params" extension. When possible, the file provenance author
 ...
 */
public class ext_boot_params extends FileExtension{
    /**
    ...
    public String getIdentifierShort() {
        return "sysfs-kernel-boot_params";
    }
