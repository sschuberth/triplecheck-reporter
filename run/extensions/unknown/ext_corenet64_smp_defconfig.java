 ...
 * FileName: corenet64_smp_defconfig.java  
 * FileCategory: SOURCE
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> This class provides details about the files that make 
 * use of the "corenet64_smp_defconfig" extension. When possible, the file provenance author
 ...
 */
public class ext_corenet64_smp_defconfig extends FileExtension{
    /**
    ...
    public String getIdentifierShort() {
        return "corenet64_smp_defconfig";
    }
