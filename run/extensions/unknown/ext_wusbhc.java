 ...
 * FileName: sysfs-class-uwb_rc-wusbhc.java  
 * FileCategory: SOURCE
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> This class provides details about the files that make 
 * use of the "sysfs-class-uwb_rc-wusbhc" extension. When possible, the file provenance author
 ...
 */
public class ext_wusbhc extends FileExtension{
    /**
    ...
    public String getIdentifierShort() {
        return "sysfs-class-uwb_rc-wusbhc";
    }
