 ...
 * FileName: i2c-diolan-u2c.java  
 * FileCategory: SOURCE
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> This class provides details about the files that make 
 * use of the "i2c-diolan-u2c" extension. When possible, the file provenance author
 ...
 */
public class ext_u2c extends FileExtension{
    /**
