 ...
 * FileName: n1-s-t-nh-sd-smp-hp.java  
 * FileCategory: SOURCE
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> This class provides details about the files that make 
 * use of the "n1-s-t-nh-sd-smp-hp" extension. When possible, the file provenance author
 ...
 */
public class ext_hp extends FileExtension{
    /**
