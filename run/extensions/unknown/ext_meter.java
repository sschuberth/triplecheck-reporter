 ...
 * FileName: bloat-o-meter.java  
 * FileCategory: SOURCE
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> This class provides details about the files that make 
 * use of the "bloat-o-meter" extension. When possible, the file provenance author
 ...
 */
public class ext_meter extends FileExtension{
    /**
