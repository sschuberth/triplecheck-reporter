 ...
 * FileName: sysfs-devices-system-xen_memory.java  
 * FileCategory: SOURCE
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> This class provides details about the files that make 
 * use of the "sysfs-devices-system-xen_memory" extension. When possible, the file provenance author
 ...
 */
public class ext_xen_memory extends FileExtension{
    /**
    ...
    public String getIdentifierShort() {
        return "sysfs-devices-system-xen_memory";
    }
