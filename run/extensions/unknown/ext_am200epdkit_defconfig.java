 ...
 * FileName: am200epdkit_defconfig.java  
 * FileCategory: SOURCE
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> This class provides details about the files that make 
 * use of the "am200epdkit_defconfig" extension. When possible, the file provenance author
 ...
 */
public class ext_am200epdkit_defconfig extends FileExtension{
    /**
