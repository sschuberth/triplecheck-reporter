 ...
 * Created: 2014-05-14T19:39:39Z
 * LicenseName: EUPL-1.1-without-appendix
 * FileName: audioexceldsp16.java  
 * FileCategory: SOURCE
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> This class provides details about the files that make 
 * use of the "audioexceldsp16" extension. When possible, the file provenance author
 ...
 */
public class ext_audioexceldsp16 extends FileExtension{
    /**
