 ...
 * FileName: test-record-branch-filter-ind_call.java  
 * FileCategory: SOURCE
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> This class provides details about the files that make 
 * use of the "test-record-branch-filter-ind_call" extension. When possible, the file provenance author
 ...
 */
public class ext_ind_call extends FileExtension{
    /**
    ...
    public String getIdentifierShort() {
        return "test-record-branch-filter-ind_call";
    }
