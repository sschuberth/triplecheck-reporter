 ...
 * Created: 2014-05-14T19:16:44Z
 * LicenseName: EUPL-1.1-without-appendix
 * FileName: find_stray_common_vars.java  
 * FileCategory: SOURCE
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> This class provides details about the files that make 
 * use of the "find_stray_common_vars" extension. When possible, the file provenance author
 ...
 */
public class ext_find_stray_common_vars extends FileExtension{
    /**
