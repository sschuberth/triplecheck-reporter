 ...
 * FileName: sysfs-devices-system-ibm-rtl.java  
 * FileCategory: SOURCE
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> This class provides details about the files that make 
 * use of the "sysfs-devices-system-ibm-rtl" extension. When possible, the file provenance author
 ...
 */
public class ext_rtl extends FileExtension{
    /**
    ...
    public String getIdentifierShort() {
        return "sysfs-devices-system-ibm-rtl";
    }
