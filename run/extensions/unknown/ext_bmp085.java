 ...
 * FileName: sysfs-i2c-bmp085.java  
 * FileCategory: SOURCE
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> This class provides details about the files that make 
 * use of the "sysfs-i2c-bmp085" extension. When possible, the file provenance author
 ...
 */
public class ext_bmp085 extends FileExtension{
    /**
