 ...
 * Created: 2014-05-14T19:38:54Z
 * LicenseName: EUPL-1.1-without-appendix
 * FileName: swp_emulation.java  
 * FileCategory: SOURCE
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> This class provides details about the files that make 
 * use of the "swp_emulation" extension. When possible, the file provenance author
 ...
 */
public class ext_swp_emulation extends FileExtension{
    /**
