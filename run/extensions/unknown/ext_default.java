 ...
 * FileName: test-record-graph-default.java  
 * FileCategory: SOURCE
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> This class provides details about the files that make 
 * use of the "test-record-graph-default" extension. When possible, the file provenance author
 ...
 */
public class ext_default extends FileExtension{
    /**
    ...
    public String getIdentifierShort() {
        return "test-record-graph-default";
    }
