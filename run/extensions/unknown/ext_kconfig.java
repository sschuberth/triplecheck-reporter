 ...
 * Created: 2014-05-14T19:35:59Z
 * LicenseName: EUPL-1.1-without-appendix
 * FileName: kconfig.java  
 * FileCategory: SOURCE
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> This class provides details about the files that make 
 * use of the "kconfig" extension. When possible, the file provenance author
 ...
 */
public class ext_kconfig extends FileExtension{
    /**
