 ...
 * FileName: configfs-spear-pcie-gadget.java  
 * FileCategory: SOURCE
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> This class provides details about the files that make 
 * use of the "configfs-spear-pcie-gadget" extension. When possible, the file provenance author
 ...
 */
public class ext_gadget extends FileExtension{
    /**
    ...
    public String getIdentifierShort() {
        return "configfs-spear-pcie-gadget";
    }
