 ...
 * Created: 2014-05-05T12:18:59Z
 * LicenseName: EUPL-1.1-without-appendix
 * FileName: wxform.java  
 * FileCategory: SOURCE
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> This class provides details about the files that make 
 * use of the "wxform" extension. When possible, the file provenance author
 ...
 */
public class wxform extends FileExtension{
    /**
