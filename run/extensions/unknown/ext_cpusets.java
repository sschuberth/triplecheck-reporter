 ...
 * Created: 2014-05-14T19:39:46Z
 * LicenseName: EUPL-1.1-without-appendix
 * FileName: fake-numa-for-cpusets.java  
 * FileCategory: SOURCE
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> This class provides details about the files that make 
 * use of the "fake-numa-for-cpusets" extension. When possible, the file provenance author
 ...
 */
public class ext_cpusets extends FileExtension{
    /**
