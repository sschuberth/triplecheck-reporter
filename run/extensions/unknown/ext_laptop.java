 ...
 * FileName: sysfs-driver-samsung-laptop.java  
 * FileCategory: SOURCE
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> This class provides details about the files that make 
 * use of the "sysfs-driver-samsung-laptop" extension. When possible, the file provenance author
 ...
 */
public class ext_laptop extends FileExtension{
    /**
    ...
    public String getIdentifierShort() {
        return "sysfs-driver-samsung-laptop";
    }
