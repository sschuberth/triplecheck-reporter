 ...
 * FileName: ath79_defconfig.java  
 * FileCategory: SOURCE
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> This class provides details about the files that make 
 * use of the "ath79_defconfig" extension. When possible, the file provenance author
 ...
 */
public class ext_ath79_defconfig extends FileExtension{
    /**
