 ...
 * FileName: tar-demands-at-least-one-ctx.java  
 * FileCategory: SOURCE
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> This class provides details about the files that make 
 * use of the "tar-demands-at-least-one-ctx" extension. When possible, the file provenance author
 ...
 */
public class ext_ctx extends FileExtension{
    /**
    ...
    public String getIdentifierShort() {
        return "tar-demands-at-least-one-ctx";
    }
