 ...
 * Created: 2014-05-14T19:16:39Z
 * LicenseName: EUPL-1.1-without-appendix
 * FileName: test_noprintf_defconfig.java  
 * FileCategory: SOURCE
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> This class provides details about the files that make 
 * use of the "test_noprintf_defconfig" extension. When possible, the file provenance author
 ...
 */
public class ext_test_noprintf_defconfig extends FileExtension{
    /**
    ...
    public String getIdentifierShort() {
        return "test_noprintf_defconfig";
    }
