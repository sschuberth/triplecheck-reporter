 ...
 * FileName: sysfs-firmware-efi-vars.java  
 * FileCategory: SOURCE
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> This class provides details about the files that make 
 * use of the "sysfs-firmware-efi-vars" extension. When possible, the file provenance author
 ...
 */
public class ext_vars extends FileExtension{
    /**
    ...
    public String getIdentifierShort() {
        return "sysfs-firmware-efi-vars";
    }
