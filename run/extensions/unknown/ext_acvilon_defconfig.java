 ...
 * FileName: bf561-acvilon_defconfig.java  
 * FileCategory: SOURCE
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> This class provides details about the files that make 
 * use of the "bf561-acvilon_defconfig" extension. When possible, the file provenance author
 ...
 */
public class ext_acvilon_defconfig extends FileExtension{
    /**
    ...
    public String getIdentifierShort() {
        return "bf561-acvilon_defconfig";
    }
