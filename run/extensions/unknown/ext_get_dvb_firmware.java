 ...
 * Created: 2014-05-14T19:39:15Z
 * LicenseName: EUPL-1.1-without-appendix
 * FileName: get_dvb_firmware.java  
 * FileCategory: SOURCE
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> This class provides details about the files that make 
 * use of the "get_dvb_firmware" extension. When possible, the file provenance author
 ...
 */
public class ext_get_dvb_firmware extends FileExtension{
    /**
