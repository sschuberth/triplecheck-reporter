 ...
 * Created: 2014-05-14T19:36:59Z
 * LicenseName: EUPL-1.1-without-appendix
 * FileName: etrax-100lx_v2_defconfig.java  
 * FileCategory: SOURCE
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> This class provides details about the files that make 
 * use of the "etrax-100lx_v2_defconfig" extension. When possible, the file provenance author
 ...
 */
public class ext_100lx_v2_defconfig extends FileExtension{
    /**
    ...
    public String getIdentifierShort() {
        return "etrax-100lx_v2_defconfig";
    }
