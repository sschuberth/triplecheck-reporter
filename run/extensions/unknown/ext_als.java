 ...
 * FileName: sysfs-bus-iio-light-lm3533-als.java  
 * FileCategory: SOURCE
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> This class provides details about the files that make 
 * use of the "sysfs-bus-iio-light-lm3533-als" extension. When possible, the file provenance author
 ...
 */
public class ext_als extends FileExtension{
    /**
    ...
    public String getIdentifierShort() {
        return "sysfs-bus-iio-light-lm3533-als";
    }
