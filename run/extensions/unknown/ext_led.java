 ...
 * FileName: sysfs-class-led.java  
 * FileCategory: SOURCE
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> This class provides details about the files that make 
 * use of the "sysfs-class-led" extension. When possible, the file provenance author
 ...
 */
public class ext_led extends FileExtension{
    /**
