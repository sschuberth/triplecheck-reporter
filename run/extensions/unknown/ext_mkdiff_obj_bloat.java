 ...
 * FileName: mkdiff_obj_bloat.java  
 * FileCategory: SOURCE
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> This class provides details about the files that make 
 * use of the "mkdiff_obj_bloat" extension. When possible, the file provenance author
 ...
 */
public class ext_mkdiff_obj_bloat extends FileExtension{
    /**
