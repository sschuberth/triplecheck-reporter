 ...
 * Created: 2014-05-14T19:38:06Z
 * LicenseName: EUPL-1.1-without-appendix
 * FileName: performance_defconfig.java  
 * FileCategory: SOURCE
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> This class provides details about the files that make 
 * use of the "performance_defconfig" extension. When possible, the file provenance author
 ...
 */
public class ext_performance_defconfig extends FileExtension{
    /**
