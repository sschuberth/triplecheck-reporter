 ...
 * Created: 2014-05-14T19:16:41Z
 * LicenseName: EUPL-1.1-without-appendix
 * FileName: ifplugd_handler.java  
 * FileCategory: SOURCE
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> This class provides details about the files that make 
 * use of the "ifplugd_handler" extension. When possible, the file provenance author
 ...
 */
public class ext_ifplugd_handler extends FileExtension{
    /**
