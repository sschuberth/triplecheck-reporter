 ...
 * FileName: cell_defconfig.java  
 * FileCategory: SOURCE
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> This class provides details about the files that make 
 * use of the "cell_defconfig" extension. When possible, the file provenance author
 ...
 */
public class ext_cell_defconfig extends FileExtension{
    /**
