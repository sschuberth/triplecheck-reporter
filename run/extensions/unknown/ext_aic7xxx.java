 ...
 * Created: 2014-05-14T19:42:41Z
 * LicenseName: EUPL-1.1-without-appendix
 * FileName: aic7xxx.java  
 * FileCategory: SOURCE
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> This class provides details about the files that make 
 * use of the "aic7xxx" extension. When possible, the file provenance author
 ...
 */
public class ext_aic7xxx extends FileExtension{
    /**
