 ...
 * FileName: ecovec24-romimage_defconfig.java  
 * FileCategory: SOURCE
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> This class provides details about the files that make 
 * use of the "ecovec24-romimage_defconfig" extension. When possible, the file provenance author
 ...
 */
public class ext_romimage_defconfig extends FileExtension{
    /**
    ...
    public String getIdentifierShort() {
        return "ecovec24-romimage_defconfig";
    }
