 ...
 * FileName: tar-handles-exclude-and-extract-lists.java  
 * FileCategory: SOURCE
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> This class provides details about the files that make 
 * use of the "tar-handles-exclude-and-extract-lists" extension. When possible, the file provenance author
 ...
 */
public class ext_lists extends FileExtension{
    /**
    ...
    public String getIdentifierShort() {
        return "tar-handles-exclude-and-extract-lists";
    }
