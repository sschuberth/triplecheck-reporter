 ...
 * FileName: sysfs-driver-hid-roccat-koneplus.java  
 * FileCategory: SOURCE
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> This class provides details about the files that make 
 * use of the "sysfs-driver-hid-roccat-koneplus" extension. When possible, the file provenance author
 ...
 */
public class ext_koneplus extends FileExtension{
    /**
    ...
    public String getIdentifierShort() {
        return "sysfs-driver-hid-roccat-koneplus";
    }
