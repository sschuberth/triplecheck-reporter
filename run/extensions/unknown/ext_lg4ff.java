 ...
 * FileName: sysfs-driver-hid-logitech-lg4ff.java  
 * FileCategory: SOURCE
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> This class provides details about the files that make 
 * use of the "sysfs-driver-hid-logitech-lg4ff" extension. When possible, the file provenance author
 ...
 */
public class ext_lg4ff extends FileExtension{
    /**
    ...
    public String getIdentifierShort() {
        return "sysfs-driver-hid-logitech-lg4ff";
    }
