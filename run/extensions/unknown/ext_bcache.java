 ...
 * FileName: sysfs-block-bcache.java  
 * FileCategory: SOURCE
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> This class provides details about the files that make 
 * use of the "sysfs-block-bcache" extension. When possible, the file provenance author
 ...
 */
public class ext_bcache extends FileExtension{
    /**
