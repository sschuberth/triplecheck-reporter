 ...
 * FileName: test-record-graph-dwarf.java  
 * FileCategory: SOURCE
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> This class provides details about the files that make 
 * use of the "test-record-graph-dwarf" extension. When possible, the file provenance author
 ...
 */
public class ext_dwarf extends FileExtension{
    /**
    ...
    public String getIdentifierShort() {
        return "test-record-graph-dwarf";
    }
