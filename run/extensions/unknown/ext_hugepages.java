 ...
 * FileName: sysfs-kernel-mm-hugepages.java  
 * FileCategory: SOURCE
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> This class provides details about the files that make 
 * use of the "sysfs-kernel-mm-hugepages" extension. When possible, the file provenance author
 ...
 */
public class ext_hugepages extends FileExtension{
    /**
    ...
    public String getIdentifierShort() {
        return "sysfs-kernel-mm-hugepages";
    }
