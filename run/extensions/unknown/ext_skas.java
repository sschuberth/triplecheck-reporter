 ...
 * FileName: makefile-skas.java  
 * FileCategory: SOURCE
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> This class provides details about the files that make 
 * use of the "makefile-skas" extension. When possible, the file provenance author
 ...
 */
public class ext_skas extends FileExtension{
    /**
