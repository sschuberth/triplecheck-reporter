 ...
 * Created: 2014-05-14T19:37:19Z
 * LicenseName: EUPL-1.1-without-appendix
 * FileName: meta2_smp_defconfig.java  
 * FileCategory: SOURCE
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> This class provides details about the files that make 
 * use of the "meta2_smp_defconfig" extension. When possible, the file provenance author
 ...
 */
public class ext_meta2_smp_defconfig extends FileExtension{
    /**
