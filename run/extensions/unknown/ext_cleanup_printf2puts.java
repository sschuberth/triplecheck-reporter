 ...
 * FileName: cleanup_printf2puts.java  
 * FileCategory: SOURCE
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> This class provides details about the files that make 
 * use of the "cleanup_printf2puts" extension. When possible, the file provenance author
 ...
 */
public class ext_cleanup_printf2puts extends FileExtension{
    /**
