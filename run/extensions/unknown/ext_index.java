 ...
 * FileName: wget-retrieves-google-index.java  
 * FileCategory: SOURCE
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> This class provides details about the files that make 
 * use of the "wget-retrieves-google-index" extension. When possible, the file provenance author
 ...
 */
public class ext_index extends FileExtension{
    /**
    ...
    public String getIdentifierShort() {
        return "wget-retrieves-google-index";
    }
