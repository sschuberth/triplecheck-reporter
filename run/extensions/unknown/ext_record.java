 ...
 * FileName: check-perf-trace-record.java  
 * FileCategory: SOURCE
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> This class provides details about the files that make 
 * use of the "check-perf-trace-record" extension. When possible, the file provenance author
 ...
 */
public class ext_record extends FileExtension{
    /**
    ...
    public String getIdentifierShort() {
        return "check-perf-trace-record";
    }
