 ...
 * FileName: sysfs-class-net-batman-adv.java  
 * FileCategory: SOURCE
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> This class provides details about the files that make 
 * use of the "sysfs-class-net-batman-adv" extension. When possible, the file provenance author
 ...
 */
public class ext_adv extends FileExtension{
    /**
    ...
    public String getIdentifierShort() {
        return "sysfs-class-net-batman-adv";
    }
