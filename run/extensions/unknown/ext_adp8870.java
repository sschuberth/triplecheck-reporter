 ...
 * FileName: sysfs-class-backlight-driver-adp8870.java  
 * FileCategory: SOURCE
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> This class provides details about the files that make 
 * use of the "sysfs-class-backlight-driver-adp8870" extension. When possible, the file provenance author
 ...
 */
public class ext_adp8870 extends FileExtension{
    /**
    ...
    public String getIdentifierShort() {
        return "sysfs-class-backlight-driver-adp8870";
    }
