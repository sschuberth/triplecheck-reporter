 ...
 * FileName: tar-handles-empty-include-and-non-empty-exclude-list.java  
 * FileCategory: SOURCE
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> This class provides details about the files that make 
 * use of the "tar-handles-empty-include-and-non-empty-exclude-list" extension. When possible, the file provenance author
 ...
 */
public class ext_list extends FileExtension{
    /**
    ...
    public String getIdentifierShort() {
        return "tar-handles-empty-include-and-non-empty-exclude-list";
    }
