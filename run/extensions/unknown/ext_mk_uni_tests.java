 ...
 * FileName: mk_uni_tests.java  
 * FileCategory: SOURCE
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> This class provides details about the files that make 
 * use of the "mk_uni_tests" extension. When possible, the file provenance author
 ...
 */
public class ext_mk_uni_tests extends FileExtension{
    /**
