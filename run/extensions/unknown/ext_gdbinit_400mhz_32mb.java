 ...
 * FileName: gdbinit_400mhz_32mb.java  
 * FileCategory: SOURCE
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> This class provides details about the files that make 
 * use of the "gdbinit_400mhz_32mb" extension. When possible, the file provenance author
 ...
 */
public class ext_gdbinit_400mhz_32mb extends FileExtension{
    /**
