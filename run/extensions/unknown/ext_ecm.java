 ...
 * FileName: configfs-usb-gadget-ecm.java  
 * FileCategory: SOURCE
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> This class provides details about the files that make 
 * use of the "configfs-usb-gadget-ecm" extension. When possible, the file provenance author
 ...
 */
public class ext_ecm extends FileExtension{
    /**
    ...
    public String getIdentifierShort() {
        return "configfs-usb-gadget-ecm";
    }
