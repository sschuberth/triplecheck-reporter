 ...
 * FileName: configfs-usb-gadget-obex.java  
 * FileCategory: SOURCE
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> This class provides details about the files that make 
 * use of the "configfs-usb-gadget-obex" extension. When possible, the file provenance author
 ...
 */
public class ext_obex extends FileExtension{
    /**
    ...
    public String getIdentifierShort() {
        return "configfs-usb-gadget-obex";
    }
