 ...
 * FileName: sysfs-bus-pci-drivers-ehci_hcd.java  
 * FileCategory: SOURCE
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> This class provides details about the files that make 
 * use of the "sysfs-bus-pci-drivers-ehci_hcd" extension. When possible, the file provenance author
 ...
 */
public class ext_ehci_hcd extends FileExtension{
    /**
    ...
    public String getIdentifierShort() {
        return "sysfs-bus-pci-drivers-ehci_hcd";
    }
