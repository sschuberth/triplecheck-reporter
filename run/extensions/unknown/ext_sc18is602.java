 ...
 * FileName: spi-sc18is602.java  
 * FileCategory: SOURCE
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> This class provides details about the files that make 
 * use of the "spi-sc18is602" extension. When possible, the file provenance author
 ...
 */
public class ext_sc18is602 extends FileExtension{
    /**
