 ...
 * Created: 2014-05-14T19:45:18Z
 * LicenseName: EUPL-1.1-without-appendix
 * FileName: kmemcheck.java  
 * FileCategory: SOURCE
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> This class provides details about the files that make 
 * use of the "kmemcheck" extension. When possible, the file provenance author
 ...
 */
public class ext_kmemcheck extends FileExtension{
    /**
