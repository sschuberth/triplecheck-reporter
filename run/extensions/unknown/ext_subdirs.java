 ...
 * FileName: tar-extracts-all-subdirs.java  
 * FileCategory: SOURCE
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> This class provides details about the files that make 
 * use of the "tar-extracts-all-subdirs" extension. When possible, the file provenance author
 ...
 */
public class ext_subdirs extends FileExtension{
    /**
    ...
    public String getIdentifierShort() {
        return "tar-extracts-all-subdirs";
    }
