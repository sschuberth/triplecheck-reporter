 ...
 * Creator: Person: nuno
 * Created: 2013-11-30T21:19:05Z
 * LicenseName: CC-BY-3.0
 * TemplateVersion: TC-2013-11-16
 * FileName: netbeans_update_resources.java  
 * FileCategory: SOURCE
 * FileCopyrightText: <text> Copyright © 2013, nuno </text>
 * FileComment: <text> This class provides details about the files that make 
 * use of the "netbeans_update_resources" extension. When possible, the file provenance author
 ...
 */
public class resources extends FileExtension{
    /**
    ...
    public String getIdentifierShort() {
        return "netbeans_update_resources";
    }
