 ...
 * FileName: q40_defconfig.java  
 * FileCategory: SOURCE
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> This class provides details about the files that make 
 * use of the "q40_defconfig" extension. When possible, the file provenance author
 ...
 */
public class ext_q40_defconfig extends FileExtension{
    /**
