 ...
 * FileName: atngw100_mrmt_defconfig.java  
 * FileCategory: SOURCE
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> This class provides details about the files that make 
 * use of the "atngw100_mrmt_defconfig" extension. When possible, the file provenance author
 ...
 */
public class ext_atngw100_mrmt_defconfig extends FileExtension{
    /**
    ...
    public String getIdentifierShort() {
        return "atngw100_mrmt_defconfig";
    }
