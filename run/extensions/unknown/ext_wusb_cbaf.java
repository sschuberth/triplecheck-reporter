 ...
 * FileName: sysfs-wusb_cbaf.java  
 * FileCategory: SOURCE
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> This class provides details about the files that make 
 * use of the "sysfs-wusb_cbaf" extension. When possible, the file provenance author
 ...
 */
public class ext_wusb_cbaf extends FileExtension{
    /**
