 ...
 * Created: 2014-05-14T19:38:47Z
 * LicenseName: EUPL-1.1-without-appendix
 * FileName: proc-sys-vm-nr_pdflush_threads.java  
 * FileCategory: SOURCE
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> This class provides details about the files that make 
 * use of the "proc-sys-vm-nr_pdflush_threads" extension. When possible, the file provenance author
 ...
 */
public class ext_nr_pdflush_threads extends FileExtension{
    /**
    ...
    public String getIdentifierShort() {
        return "proc-sys-vm-nr_pdflush_threads";
    }
