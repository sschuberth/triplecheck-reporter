 ...
 * FileName: gzip-accepts-multiple-files.java  
 * FileCategory: SOURCE
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> This class provides details about the files that make 
 * use of the "gzip-accepts-multiple-files" extension. When possible, the file provenance author
 ...
 */
public class ext_files extends FileExtension{
    /**
    ...
    public String getIdentifierShort() {
        return "gzip-accepts-multiple-files";
    }
