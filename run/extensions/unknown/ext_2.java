 ...
 * FileName: test-stat-detailed-2.java  
 * FileCategory: SOURCE
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> This class provides details about the files that make 
 * use of the "test-stat-detailed-2" extension. When possible, the file provenance author
 ...
 */
public class ext_2 extends FileExtension{
    /**
