 ...
 * Created: 2014-05-14T19:38:28Z
 * LicenseName: EUPL-1.1-without-appendix
 * FileName: unicore32_defconfig.java  
 * FileCategory: SOURCE
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> This class provides details about the files that make 
 * use of the "unicore32_defconfig" extension. When possible, the file provenance author
 ...
 */
public class ext_unicore32_defconfig extends FileExtension{
    /**
