 ...
 * Created: 2014-05-14T19:37:25Z
 * LicenseName: EUPL-1.1-without-appendix
 * FileName: malta_kvm_guest_defconfig.java  
 * FileCategory: SOURCE
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> This class provides details about the files that make 
 * use of the "malta_kvm_guest_defconfig" extension. When possible, the file provenance author
 ...
 */
public class ext_malta_kvm_guest_defconfig extends FileExtension{
    /**
    ...
    public String getIdentifierShort() {
        return "malta_kvm_guest_defconfig";
    }
