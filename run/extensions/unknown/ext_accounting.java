 ...
 * FileName: overcommit-accounting.java  
 * FileCategory: SOURCE
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> This class provides details about the files that make 
 * use of the "overcommit-accounting" extension. When possible, the file provenance author
 ...
 */
public class ext_accounting extends FileExtension{
    /**
