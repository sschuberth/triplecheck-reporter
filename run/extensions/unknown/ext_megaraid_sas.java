 ...
 * Created: 2014-05-14T19:39:36Z
 * LicenseName: EUPL-1.1-without-appendix
 * FileName: megaraid_sas.java  
 * FileCategory: SOURCE
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> This class provides details about the files that make 
 * use of the "megaraid_sas" extension. When possible, the file provenance author
 ...
 */
public class ext_megaraid_sas extends FileExtension{
    /**
