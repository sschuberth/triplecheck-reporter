 ...
 * Created: 2014-05-01T10:51:33Z
 * LicenseName: EUPL-1.1-without-appendix
 * FileName: cbproj.java  
 * FileCategory: SOURCE
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> This class provides details about the files that make 
 * use of the "cbproj" extension. When possible, the file provenance author
 ...
 */
public class cbproj extends FileExtension{
    /**
