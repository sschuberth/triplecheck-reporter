 ...
 * FileName: test-record-c0.java  
 * FileCategory: SOURCE
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> This class provides details about the files that make 
 * use of the "test-record-c0" extension. When possible, the file provenance author
 ...
 */
public class ext_c0 extends FileExtension{
    /**
