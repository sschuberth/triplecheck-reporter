 ...
 * FileName: sysfs-kernel-vmcoreinfo.java  
 * FileCategory: SOURCE
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> This class provides details about the files that make 
 * use of the "sysfs-kernel-vmcoreinfo" extension. When possible, the file provenance author
 ...
 */
public class ext_vmcoreinfo extends FileExtension{
    /**
    ...
    public String getIdentifierShort() {
        return "sysfs-kernel-vmcoreinfo";
    }
