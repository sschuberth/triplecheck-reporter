 ...
 * FileName: test-record-freq.java  
 * FileCategory: SOURCE
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> This class provides details about the files that make 
 * use of the "test-record-freq" extension. When possible, the file provenance author
 ...
 */
public class ext_freq extends FileExtension{
    /**
