 ...
 * FileName: mini2440_defconfig.java  
 * FileCategory: SOURCE
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> This class provides details about the files that make 
 * use of the "mini2440_defconfig" extension. When possible, the file provenance author
 ...
 */
public class ext_mini2440_defconfig extends FileExtension{
    /**
