 ...
 * FileName: sysfs-bus-iio-trigger-sysfs.java  
 * FileCategory: SOURCE
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> This class provides details about the files that make 
 * use of the "sysfs-bus-iio-trigger-sysfs" extension. When possible, the file provenance author
 ...
 */
public class ext_sysfs extends FileExtension{
    /**
    ...
    public String getIdentifierShort() {
        return "sysfs-bus-iio-trigger-sysfs";
    }
