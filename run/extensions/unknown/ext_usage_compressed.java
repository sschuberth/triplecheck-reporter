 ...
 * Created: 2014-05-14T19:16:38Z
 * LicenseName: EUPL-1.1-without-appendix
 * FileName: usage_compressed.java  
 * FileCategory: SOURCE
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> This class provides details about the files that make 
 * use of the "usage_compressed" extension. When possible, the file provenance author
 ...
 */
public class ext_usage_compressed extends FileExtension{
    /**
