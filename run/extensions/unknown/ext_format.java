 ...
 * Created: 2014-05-14T19:38:48Z
 * LicenseName: EUPL-1.1-without-appendix
 * FileName: sysfs-bus-event_source-devices-format.java  
 * FileCategory: SOURCE
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> This class provides details about the files that make 
 * use of the "sysfs-bus-event_source-devices-format" extension. When possible, the file provenance author
 ...
 */
public class ext_format extends FileExtension{
    /**
    ...
    public String getIdentifierShort() {
        return "sysfs-bus-event_source-devices-format";
    }
