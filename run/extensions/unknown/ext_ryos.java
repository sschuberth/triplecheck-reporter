 ...
 * FileName: sysfs-driver-hid-roccat-ryos.java  
 * FileCategory: SOURCE
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> This class provides details about the files that make 
 * use of the "sysfs-driver-hid-roccat-ryos" extension. When possible, the file provenance author
 ...
 */
public class ext_ryos extends FileExtension{
    /**
    ...
    public String getIdentifierShort() {
        return "sysfs-driver-hid-roccat-ryos";
    }
