 ...
 * FileName: twl4030-madc-hwmon.java  
 * FileCategory: SOURCE
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> This class provides details about the files that make 
 * use of the "twl4030-madc-hwmon" extension. When possible, the file provenance author
 ...
 */
public class ext_hwmon extends FileExtension{
    /**
