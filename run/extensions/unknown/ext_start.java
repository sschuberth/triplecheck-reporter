 ...
 * Created: 2014-05-14T19:38:50Z
 * LicenseName: EUPL-1.1-without-appendix
 * FileName: sysfs-driver-intel-rapid-start.java  
 * FileCategory: SOURCE
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> This class provides details about the files that make 
 * use of the "sysfs-driver-intel-rapid-start" extension. When possible, the file provenance author
 ...
 */
public class ext_start extends FileExtension{
    /**
    ...
    public String getIdentifierShort() {
        return "sysfs-driver-intel-rapid-start";
    }
