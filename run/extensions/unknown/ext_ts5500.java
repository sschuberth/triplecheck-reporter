 ...
 * FileName: sysfs-platform-ts5500.java  
 * FileCategory: SOURCE
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> This class provides details about the files that make 
 * use of the "sysfs-platform-ts5500" extension. When possible, the file provenance author
 ...
 */
public class ext_ts5500 extends FileExtension{
    /**
