 ...
 * FileName: tar_with_prefix_fields.java  
 * FileCategory: SOURCE
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> This class provides details about the files that make 
 * use of the "tar_with_prefix_fields" extension. When possible, the file provenance author
 ...
 */
public class ext_tar_with_prefix_fields extends FileExtension{
    /**
