 ...
 * FileName: sysfs-devices-firmware_node.java  
 * FileCategory: SOURCE
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> This class provides details about the files that make 
 * use of the "sysfs-devices-firmware_node" extension. When possible, the file provenance author
 ...
 */
public class ext_firmware_node extends FileExtension{
    /**
    ...
    public String getIdentifierShort() {
        return "sysfs-devices-firmware_node";
    }
