 ...
 * FileName: sun3_defconfig.java  
 * FileCategory: SOURCE
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> This class provides details about the files that make 
 * use of the "sun3_defconfig" extension. When possible, the file provenance author
 ...
 */
public class ext_sun3_defconfig extends FileExtension{
    /**
