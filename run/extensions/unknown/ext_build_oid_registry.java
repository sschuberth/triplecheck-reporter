 ...
 * Created: 2014-05-14T19:45:17Z
 * LicenseName: EUPL-1.1-without-appendix
 * FileName: build_oid_registry.java  
 * FileCategory: SOURCE
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> This class provides details about the files that make 
 * use of the "build_oid_registry" extension. When possible, the file provenance author
 ...
 */
public class ext_build_oid_registry extends FileExtension{
    /**
