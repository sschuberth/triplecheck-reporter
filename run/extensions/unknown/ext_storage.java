 ...
 * FileName: configfs-usb-gadget-mass-storage.java  
 * FileCategory: SOURCE
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> This class provides details about the files that make 
 * use of the "configfs-usb-gadget-mass-storage" extension. When possible, the file provenance author
 ...
 */
public class ext_storage extends FileExtension{
    /**
    ...
    public String getIdentifierShort() {
        return "configfs-usb-gadget-mass-storage";
    }
