 ...
 * FileName: exynos_thermal_emulation.java  
 * FileCategory: SOURCE
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> This class provides details about the files that make 
 * use of the "exynos_thermal_emulation" extension. When possible, the file provenance author
 ...
 */
public class ext_exynos_thermal_emulation extends FileExtension{
    /**
    ...
    public String getIdentifierShort() {
        return "exynos_thermal_emulation";
    }
