 ...
 * FileName: dirname-handles-single-component.java  
 * FileCategory: SOURCE
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> This class provides details about the files that make 
 * use of the "dirname-handles-single-component" extension. When possible, the file provenance author
 ...
 */
public class ext_component extends FileExtension{
    /**
    ...
    public String getIdentifierShort() {
        return "dirname-handles-single-component";
    }
