 ...
 * Created: 2014-05-14T19:38:49Z
 * LicenseName: EUPL-1.1-without-appendix
 * FileName: sysfs-class-rtc-rtc0-device-rtc_calibration.java  
 * FileCategory: SOURCE
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> This class provides details about the files that make 
 * use of the "sysfs-class-rtc-rtc0-device-rtc_calibration" extension. When possible, the file provenance author
 ...
 */
public class ext_rtc_calibration extends FileExtension{
    /**
    ...
    public String getIdentifierShort() {
        return "sysfs-class-rtc-rtc0-device-rtc_calibration";
    }
