 ...
 * FileName: sysfs-devices-platform-docg3.java  
 * FileCategory: SOURCE
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> This class provides details about the files that make 
 * use of the "sysfs-devices-platform-docg3" extension. When possible, the file provenance author
 ...
 */
public class ext_docg3 extends FileExtension{
    /**
    ...
    public String getIdentifierShort() {
        return "sysfs-devices-platform-docg3";
    }
