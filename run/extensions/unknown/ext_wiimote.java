 ...
 * FileName: sysfs-driver-hid-wiimote.java  
 * FileCategory: SOURCE
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> This class provides details about the files that make 
 * use of the "sysfs-driver-hid-wiimote" extension. When possible, the file provenance author
 ...
 */
public class ext_wiimote extends FileExtension{
    /**
    ...
    public String getIdentifierShort() {
        return "sysfs-driver-hid-wiimote";
    }
