 ...
 * FileName: sysfs-memory-page-offline.java  
 * FileCategory: SOURCE
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> This class provides details about the files that make 
 * use of the "sysfs-memory-page-offline" extension. When possible, the file provenance author
 ...
 */
public class ext_offline extends FileExtension{
    /**
    ...
    public String getIdentifierShort() {
        return "sysfs-memory-page-offline";
    }
