 ...
 * Created: 2014-05-14T19:36:03Z
 * LicenseName: EUPL-1.1-without-appendix
 * FileName: fpga_noramfs_defconfig.java  
 * FileCategory: SOURCE
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> This class provides details about the files that make 
 * use of the "fpga_noramfs_defconfig" extension. When possible, the file provenance author
 ...
 */
public class ext_fpga_noramfs_defconfig extends FileExtension{
    /**
