 ...
 * FileName: sysfs-bus-pci-devices-cciss.java  
 * FileCategory: SOURCE
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> This class provides details about the files that make 
 * use of the "sysfs-bus-pci-devices-cciss" extension. When possible, the file provenance author
 ...
 */
public class ext_cciss extends FileExtension{
    /**
    ...
    public String getIdentifierShort() {
        return "sysfs-bus-pci-devices-cciss";
    }
