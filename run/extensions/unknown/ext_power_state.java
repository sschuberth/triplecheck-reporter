 ...
 * FileName: sysfs-devices-power_state.java  
 * FileCategory: SOURCE
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> This class provides details about the files that make 
 * use of the "sysfs-devices-power_state" extension. When possible, the file provenance author
 ...
 */
public class ext_power_state extends FileExtension{
    /**
    ...
    public String getIdentifierShort() {
        return "sysfs-devices-power_state";
    }
