 ...
 * FileName: 712_defconfig.java  
 * FileCategory: SOURCE
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> This class provides details about the files that make 
 * use of the "712_defconfig" extension. When possible, the file provenance author
 ...
 */
public class ext_712_defconfig extends FileExtension{
    /**
