 ...
 * FileName: sysfs-devices-resource_in_use.java  
 * FileCategory: SOURCE
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> This class provides details about the files that make 
 * use of the "sysfs-devices-resource_in_use" extension. When possible, the file provenance author
 ...
 */
public class ext_resource_in_use extends FileExtension{
    /**
    ...
    public String getIdentifierShort() {
        return "sysfs-devices-resource_in_use";
    }
