 ...
 * FileName: test-record-no-inherit.java  
 * FileCategory: SOURCE
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> This class provides details about the files that make 
 * use of the "test-record-no-inherit" extension. When possible, the file provenance author
 ...
 */
public class ext_inherit extends FileExtension{
    /**
