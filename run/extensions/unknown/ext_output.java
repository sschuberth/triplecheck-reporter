 ...
 * FileName: dd-copies-from-standard-input-to-standard-output.java  
 * FileCategory: SOURCE
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> This class provides details about the files that make 
 * use of the "dd-copies-from-standard-input-to-standard-output" extension. When possible, the file provenance author
 ...
 */
public class ext_output extends FileExtension{
    /**
    ...
    public String getIdentifierShort() {
        return "dd-copies-from-standard-input-to-standard-output";
    }
