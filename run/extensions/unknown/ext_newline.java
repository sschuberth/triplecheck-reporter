 ...
 * FileName: echo-does-not-print-newline.java  
 * FileCategory: SOURCE
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> This class provides details about the files that make 
 * use of the "echo-does-not-print-newline" extension. When possible, the file provenance author
 ...
 */
public class ext_newline extends FileExtension{
    /**
    ...
    public String getIdentifierShort() {
        return "echo-does-not-print-newline";
    }
