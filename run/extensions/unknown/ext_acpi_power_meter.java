 ...
 * FileName: acpi_power_meter.java  
 * FileCategory: SOURCE
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> This class provides details about the files that make 
 * use of the "acpi_power_meter" extension. When possible, the file provenance author
 ...
 */
public class ext_acpi_power_meter extends FileExtension{
    /**
