 ...
 * FileName: mpc834x_itxgp_defconfig.java  
 * FileCategory: SOURCE
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> This class provides details about the files that make 
 * use of the "mpc834x_itxgp_defconfig" extension. When possible, the file provenance author
 ...
 */
public class ext_mpc834x_itxgp_defconfig extends FileExtension{
    /**
    ...
    public String getIdentifierShort() {
        return "mpc834x_itxgp_defconfig";
    }
