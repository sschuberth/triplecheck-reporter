 ...
 * FileName: dirname-handles-multiple-slashes.java  
 * FileCategory: SOURCE
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> This class provides details about the files that make 
 * use of the "dirname-handles-multiple-slashes" extension. When possible, the file provenance author
 ...
 */
public class ext_slashes extends FileExtension{
    /**
    ...
    public String getIdentifierShort() {
        return "dirname-handles-multiple-slashes";
    }
