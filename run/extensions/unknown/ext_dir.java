 ...
 * FileName: cp-a-files-to-dir.java  
 * FileCategory: SOURCE
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> This class provides details about the files that make 
 * use of the "cp-a-files-to-dir" extension. When possible, the file provenance author
 ...
 */
public class ext_dir extends FileExtension{
    /**
