 ...
 * Created: 2014-05-14T19:37:43Z
 * LicenseName: EUPL-1.1-without-appendix
 * FileName: generic-32bit_defconfig.java  
 * FileCategory: SOURCE
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> This class provides details about the files that make 
 * use of the "generic-32bit_defconfig" extension. When possible, the file provenance author
 ...
 */
public class ext_32bit_defconfig extends FileExtension{
    /**
    ...
    public String getIdentifierShort() {
        return "generic-32bit_defconfig";
    }
