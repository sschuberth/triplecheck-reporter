 ...
 * FileName: bunzip2-reads-from-standard-input.java  
 * FileCategory: SOURCE
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> This class provides details about the files that make 
 * use of the "bunzip2-reads-from-standard-input" extension. When possible, the file provenance author
 ...
 */
public class ext_input extends FileExtension{
    /**
    ...
    public String getIdentifierShort() {
        return "bunzip2-reads-from-standard-input";
    }
