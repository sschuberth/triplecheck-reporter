 ...
 * Created: 2014-05-14T19:37:09Z
 * LicenseName: EUPL-1.1-without-appendix
 * FileName: toolchain-flags.java  
 * FileCategory: SOURCE
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> This class provides details about the files that make 
 * use of the "toolchain-flags" extension. When possible, the file provenance author
 ...
 */
public class ext_flags extends FileExtension{
    /**
