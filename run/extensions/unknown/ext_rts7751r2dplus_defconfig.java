 ...
 * FileName: rts7751r2dplus_defconfig.java  
 * FileCategory: SOURCE
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> This class provides details about the files that make 
 * use of the "rts7751r2dplus_defconfig" extension. When possible, the file provenance author
 ...
 */
public class ext_rts7751r2dplus_defconfig extends FileExtension{
    /**
    ...
    public String getIdentifierShort() {
        return "rts7751r2dplus_defconfig";
    }
