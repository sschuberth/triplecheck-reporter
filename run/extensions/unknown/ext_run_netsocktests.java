 ...
 * Created: 2014-05-14T19:46:22Z
 * LicenseName: EUPL-1.1-without-appendix
 * FileName: run_netsocktests.java  
 * FileCategory: SOURCE
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> This class provides details about the files that make 
 * use of the "run_netsocktests" extension. When possible, the file provenance author
 ...
 */
public class ext_run_netsocktests extends FileExtension{
    /**
