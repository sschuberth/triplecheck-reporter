 ...
 * Created: 2014-05-14T19:36:46Z
 * LicenseName: EUPL-1.1-without-appendix
 * FileName: kconfig_mrmt.java  
 * FileCategory: SOURCE
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> This class provides details about the files that make 
 * use of the "kconfig_mrmt" extension. When possible, the file provenance author
 ...
 */
public class ext_kconfig_mrmt extends FileExtension{
    /**
