 ...
 * FileName: bunzip2-removes-compressed-file.java  
 * FileCategory: SOURCE
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> This class provides details about the files that make 
 * use of the "bunzip2-removes-compressed-file" extension. When possible, the file provenance author
 ...
 */
public class ext_file extends FileExtension{
    /**
    ...
    public String getIdentifierShort() {
        return "bunzip2-removes-compressed-file";
    }
