 ...
 * FileName: secureedge5410_defconfig.java  
 * FileCategory: SOURCE
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> This class provides details about the files that make 
 * use of the "secureedge5410_defconfig" extension. When possible, the file provenance author
 ...
 */
public class ext_secureedge5410_defconfig extends FileExtension{
    /**
    ...
    public String getIdentifierShort() {
        return "secureedge5410_defconfig";
    }
