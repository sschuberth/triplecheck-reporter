 ...
 * FileName: sysfs-driver-usb-usbtmc.java  
 * FileCategory: SOURCE
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> This class provides details about the files that make 
 * use of the "sysfs-driver-usb-usbtmc" extension. When possible, the file provenance author
 ...
 */
public class ext_usbtmc extends FileExtension{
    /**
    ...
    public String getIdentifierShort() {
        return "sysfs-driver-usb-usbtmc";
    }
