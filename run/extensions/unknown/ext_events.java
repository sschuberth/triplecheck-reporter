 ...
 * FileName: sysfs-bus-event_source-devices-events.java  
 * FileCategory: SOURCE
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> This class provides details about the files that make 
 * use of the "sysfs-bus-event_source-devices-events" extension. When possible, the file provenance author
 ...
 */
public class ext_events extends FileExtension{
    /**
    ...
    public String getIdentifierShort() {
        return "sysfs-bus-event_source-devices-events";
    }
