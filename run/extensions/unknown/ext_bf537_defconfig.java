 ...
 * FileName: tcm-bf537_defconfig.java  
 * FileCategory: SOURCE
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> This class provides details about the files that make 
 * use of the "tcm-bf537_defconfig" extension. When possible, the file provenance author
 ...
 */
public class ext_bf537_defconfig extends FileExtension{
    /**
