 ...
 * FileName: pwd-prints-working-directory.java  
 * FileCategory: SOURCE
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> This class provides details about the files that make 
 * use of the "pwd-prints-working-directory" extension. When possible, the file provenance author
 ...
 */
public class ext_directory extends FileExtension{
    /**
    ...
    public String getIdentifierShort() {
        return "pwd-prints-working-directory";
    }
