 ...
 * FileName: sysfs-class-devfreq.java  
 * FileCategory: SOURCE
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> This class provides details about the files that make 
 * use of the "sysfs-class-devfreq" extension. When possible, the file provenance author
 ...
 */
public class ext_devfreq extends FileExtension{
    /**
