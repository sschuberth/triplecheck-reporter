 ...
 * FileName: markeins_defconfig.java  
 * FileCategory: SOURCE
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> This class provides details about the files that make 
 * use of the "markeins_defconfig" extension. When possible, the file provenance author
 ...
 */
public class ext_markeins_defconfig extends FileExtension{
    /**
