 ...
 * FileName: gzip-accepts-single-minus.java  
 * FileCategory: SOURCE
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> This class provides details about the files that make 
 * use of the "gzip-accepts-single-minus" extension. When possible, the file provenance author
 ...
 */
public class ext_minus extends FileExtension{
    /**
    ...
    public String getIdentifierShort() {
        return "gzip-accepts-single-minus";
    }
