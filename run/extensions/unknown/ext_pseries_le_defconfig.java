 ...
 * FileName: pseries_le_defconfig.java  
 * FileCategory: SOURCE
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> This class provides details about the files that make 
 * use of the "pseries_le_defconfig" extension. When possible, the file provenance author
 ...
 */
public class ext_pseries_le_defconfig extends FileExtension{
    /**
