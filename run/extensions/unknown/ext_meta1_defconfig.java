 ...
 * FileName: meta1_defconfig.java  
 * FileCategory: SOURCE
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> This class provides details about the files that make 
 * use of the "meta1_defconfig" extension. When possible, the file provenance author
 ...
 */
public class ext_meta1_defconfig extends FileExtension{
    /**
