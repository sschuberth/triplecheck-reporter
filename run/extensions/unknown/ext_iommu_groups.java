 ...
 * Created: 2014-05-14T19:38:51Z
 * LicenseName: EUPL-1.1-without-appendix
 * FileName: sysfs-kernel-iommu_groups.java  
 * FileCategory: SOURCE
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> This class provides details about the files that make 
 * use of the "sysfs-kernel-iommu_groups" extension. When possible, the file provenance author
 ...
 */
public class ext_iommu_groups extends FileExtension{
    /**
    ...
    public String getIdentifierShort() {
        return "sysfs-kernel-iommu_groups";
    }
