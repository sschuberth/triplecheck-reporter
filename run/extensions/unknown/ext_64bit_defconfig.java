 ...
 * FileName: generic-64bit_defconfig.java  
 * FileCategory: SOURCE
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> This class provides details about the files that make 
 * use of the "generic-64bit_defconfig" extension. When possible, the file provenance author
 ...
 */
public class ext_64bit_defconfig extends FileExtension{
    /**
    ...
    public String getIdentifierShort() {
        return "generic-64bit_defconfig";
    }
