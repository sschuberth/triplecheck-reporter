 ...
 * FileName: bf561-ezkit-smp_defconfig.java  
 * FileCategory: SOURCE
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> This class provides details about the files that make 
 * use of the "bf561-ezkit-smp_defconfig" extension. When possible, the file provenance author
 ...
 */
public class ext_smp_defconfig extends FileExtension{
    /**
    ...
    public String getIdentifierShort() {
        return "bf561-ezkit-smp_defconfig";
    }
