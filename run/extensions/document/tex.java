 ...
 * Created: 2014-04-06T10:31:02Z
 * LicenseName: CC-BY-4.0
 * FileName: tex.java  
 * FileCategory: SOURCE
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> This class provides details about the files that make 
 * use of the "tex" extension. When possible, the file provenance author
 ...
 */
public class tex extends FileExtension{
    /**
    ...
    public String getDescription() {
        return "LaTeX source document file"; // file type description
    }
