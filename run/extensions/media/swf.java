 ...
 * Created: 2014-04-09T21:46:23Z
 * LicenseName: EUPL-1.1-without-appendix
 * FileName: swf.java  
 * FileCategory: SOURCE
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> This class provides details about the files that make 
 * use of the "swf" extension. When possible, the file provenance author
 ...
 */
public class swf extends FileExtension{
    /**
    ...
    public String getDescription() {
        return "ShockWave Flash Animated file"; // file type description
    }
