 ...
 * Created: 2014-04-22T13:15:44Z
 * LicenseName: EUPL-1.1-without-appendix
 * FileName: xpm.java  
 * FileCategory: SOURCE
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> This class provides details about the files that make 
 * use of the "xpm" extension. When possible, the file provenance author
 ...
 */
public class xpm extends FileExtension{
    /**
    ...
    public String getDescription() {
        return "X11 Pixel Map graphics file"; // file type description
    }
