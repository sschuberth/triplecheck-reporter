 ...
 * use of the "sql" extension. When possible, the file provenance author
 ...
 */
public class sql extends FileExtension{
    /**
    ...
    public FileLanguage getLanguage(){
        return FileLanguage.SQL; // to which language is the file more related?
    }
