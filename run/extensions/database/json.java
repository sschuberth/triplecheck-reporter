 ...
 * Created: 2014-04-06T10:31:05Z
 * LicenseName: CC-BY-4.0
 * FileName: json.java  
 * FileCategory: SOURCE
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 * FileComment: <text> This class provides details about the files that make 
 * use of the "json" extension. When possible, the file provenance author
 ...
 */
public class json extends FileExtension{
    /**
    ...
    public String getDescription() {
        return "JavaScript Object Notation File"; // file type description
    }
