...
public class CECILL_2_0 extends License{
   /**
    ...
    public String getTerms(){
        ...
        + "ar cette licence dans le cadre d'un modèle de diffusion en logiciel libre.\n"
        + "\n"
        ...
        + "\n"
        + "GNU GPL: désigne la GNU General Public License dans sa version 2 ou toute versio"
        + "n ultérieure, telle que publiée par Free Software Foundation Inc.\n"
        + "\n"
        ...
        + "\n"
        + "Lorsque le Licencié apporte une Contribution au Logiciel, les conditions de dist"
        + "ribution du Logiciel Modifié en résultant sont alors soumises à l'intégralité de"
        + "s dispositions du Contrat.\n"
        + "\n"
        + "Le Licencié est autorisé à distribuer le Logiciel Modifié, sous forme de code so"
        + "urce ou de code objet, à condition que cette distribution respecte les dispositi"
        + "ons du Contrat dans leur totalité et soit accompagnée:\n"
        + "\n"
        + "d'un exemplaire du Contrat,\n"
        + "\n"
        + "d'un avertissement relatif à la restriction de garantie et de responsabilité du "
        ...
        + "\n"
        + "Le Licencié peut inclure un code soumis aux dispositions d'une des versions de l"
        + "a licence GNU GPL dans le Logiciel modifié ou non et distribuer l'ensemble sous "
        + "les conditions de la même version de la licence GNU GPL.\n"
        + "\n"
        + "Le Licencié peut inclure le Logiciel modifié ou non dans un code soumis aux disp"
        + "ositions d'une des versions de la licence GNU GPL et distribuer l'ensemble sous "
        + "les conditions de la même version de la licence GNU GPL.\n"
        + "\n"
        ...
        + "ion postérieure, sous réserve des dispositions de l'article 5.3.4.\n"
        + "\n"
