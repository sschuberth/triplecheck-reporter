 ...
 * Created: 2014-04-26T13:45:24Z
 * LicenseName: Apache-2.0
 * FileName: YPL_1_0.java 
 * FileCategory: SOURCE
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 */


public class YPL_1_0 extends License{
   /**
    ...
    @Override
    public String getId(){
        return "YPL-1.0"; // short and unique id
    }
    ...
    public String getTitle(){
        return "Yahoo! Public License v1.0"; // full text title
    }
    ...
    public String getTerms(){
        return "Yahoo! Public License, Version 1.0 (YPL)\n"
        + "\n"
        ...
        + "6.2- In the event Yahoo! determines that You have breached this Agreement, Yah"
        + "oo! may terminate this Agreement.\n"
