...
public class CDDL_1_1 extends License{
   /**
    ...
    public String getTerms(){
        return "COMMON DEVELOPMENT AND DISTRIBUTION LICENSE (CDDL)Version 1.1\n"
        + "\n"
        + "1. Definitions.\n"
        + "\n"
        ...
        + "\n"
        + "4.1. New Versions.\n"
        + "Oracle is the initial license steward and may publish revised and/or new version"
        + "s of this License from time to time. Each version will be given a distinguishing"
        + " version number. Except as provided in Section 4.3, no one other than the licens"
        + "e steward has the right to modify this License.\n"
        + "\n"
        ...
        + " patent infringement litigation, then the reasonable value of the licenses grant"
        + "ed by such Participant under Sections 2.1 or 2.2 shall be taken into account in "
        + "determining the amount or value of any payment or license.\n"
        + "\n"
        + "6.4. In the event of termination under Sections 6.1 or 6.2 above, all end user l"
        ...
        + "UENTIAL DAMAGES OF ANY CHARACTER INCLUDING, WITHOUT LIMITATION, DAMAGES FOR LOSS"
        + " OF GOODWILL, WORK STOPPAGE, COMPUTER FAILURE OR MALFUNCTION, OR ANY AND ALL OTH"
        + "ER COMMERCIAL DAMAGES OR LOSSES, EVEN IF SUCH PARTY SHALL HAVE BEEN INFORMED OF "
        + "THE POSSIBILITY OF SUCH DAMAGES. THIS LIMITATION OF LIABILITY SHALL NOT APPLY TO"
        + " LIABILITY FOR DEATH OR PERSONAL INJURY RESULTING FROM SUCH PARTY'S NEGLIGENCE T"
        + "O THE EXTENT APPLICABLE LAW PROHIBITS SUCH LIMITATION. SOME JURISDICTIONS DO NOT"
        + " ALLOW THE EXCLUSION OR LIMITATION OF INCIDENTAL OR CONSEQUENTIAL DAMAGES, SO TH"
        + "IS EXCLUSION AND LIMITATION MAY NOT APPLY TO YOU.\n"
        + "\n"
        ...
        + "(CDDL)\n"
        + "The code released under the CDDL shall be governed by the laws of the State of C"
        + "alifornia (excluding conflict-of-law provisions). Any litigation relating to thi"
        + "s License shall be subject to the jurisdiction of the Federal Courts of the Nort"
        + "hern District of California and the state courts of the State of California, wit"
        + "h venue lying in Santa Clara County, California.\n"
; // the license text
    }
