 ...
 * Created: 2014-04-26T13:45:06Z
 * LicenseName: Apache-2.0
 * FileName: OSL_2_0.java 
 * FileCategory: SOURCE
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 */


public class OSL_2_0 extends License{
   /**
    ...
    @Override
    public String getId(){
        return "OSL-2.0"; // short and unique id
    }
    ...
    public String getTitle(){
        return "Open Software License 2.0"; // full text title
    }
    ...
    public String getTerms(){
        ...
        + "s of the U.S. Copyright Act, 17 U.S.C. 101 et seq., the equivalent laws of other"
        + " countries, and international treaty. This section shall survive the termination"
        + " of this License.\n"
        + "\n"
        ...
        + "\n"
        + "This license is Copyright (C) 2003 Lawrence E. Rosen. All rights reserved. Permi"
