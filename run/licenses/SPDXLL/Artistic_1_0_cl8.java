...
public class Artistic_1_0_cl8 extends License{
   /**
    ...
    public String getTerms(){
        ...
        + "pt is made to make this Package's interfaces visible to the end user of the comm"
        + "ercial distribution. Such use shall not be construed as a distribution of this P"
        + "ackage.\n"
        + "\n"
