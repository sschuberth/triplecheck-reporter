 ...
 * Creator: Person: nuno
 * Created: 2014-06-01T13:27:23Z
 * LicenseName: EUPL-1.1-without-appendix
 * FileName: AFL_2_1.java 
 * FileCategory: SOURCE
 * FileCopyrightText: <text> Copyright (c) 2014, nuno </text>
 */


public class AFL_2_1 extends License{
   /**
    ...
    @Override
    public String getId(){
        return "AFL-2.1"; // short and unique id
    }
    ...
    public String getTitle(){
        return "Academic Free License v2.1"; // full text title
    }
    ...
    public String getTerms(){
        ...
        + "k;\n"
        + "\n"
        + " c) to distribute copies of the Original Work and Derivative Works to the publi"
        + "c; \n"
        + "\n"
        ...
        + " obtain the express assent of recipients to the terms of this License. Nothing e"
        + "lse but this License (or another written agreement between Licensor and You) gra"
        + "nts You permission to create Derivative Works based upon the Original Work or to"
        + " exercise any of the rights granted in Section 1 herein, and any attempt to do s"
        + "o except under the terms of this License (or another written agreement between L"
        + "icensor and You) is expressly prohibited by U.S. copyright law, the equivalent l"
        + "aws of other countries, and by international treaty. Therefore, by exercising an"
        + "y of the rights granted to You in Section 1 herein, You indicate Your acceptance"
