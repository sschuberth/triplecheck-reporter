 ...
 * Created: 2014-04-26T13:33:04Z
 * LicenseName: Apache-2.0
 * FileName: OSL_3_0.java 
 * FileCategory: SOURCE
 * FileCopyrightText: <text> Copyright (c) 2014, Nuno Brito </text>
 */


public class OSL_3_0 extends License{
   /**
    ...
    @Override
    public String getId(){
        return "OSL-3.0"; // short and unique id
    }
    ...
    public String getTitle(){
        return "Open Software License 3.0"; // full text title
    }
    ...
    public String getTerms(){
        return "Open Software License v. 3.0 (OSL-3.0)\n"
        + "\n"
        ...
        + "s that You distribute or communicate shall be licensed under this Open Software "
        + "License;\n"
