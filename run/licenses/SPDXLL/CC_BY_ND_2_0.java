 ...
 * Creator: Person: nuno
 * Created: 2014-06-01T13:27:53Z
 * LicenseName: EUPL-1.1-without-appendix
 * FileName: CC_BY_ND_2_0.java 
 * FileCategory: SOURCE
 * FileCopyrightText: <text> Copyright (c) 2014, nuno </text>
 */


public class CC_BY_ND_2_0 extends License{
   /**
    ...
    @Override
    public String getId(){
        return "CC-BY-ND-2.0"; // short and unique id
    }
    ...
    public String getTitle(){
        return "Creative Commons Attribution No Derivatives 2.0"; // full text title
    }
    ...
    public String getTerms(){
        return "Creative Commons Attribution-NoDerivs 2.0\n"
        + "\n"
