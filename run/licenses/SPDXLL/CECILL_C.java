...
public class CECILL_C extends License{
   /**
    ...
    public String getTerms(){
        return "CONTRAT DE LICENCE DE LOGICIEL LIBRE CeCILL-C\n"
        + "\n"
        + "Avertissement\n"
        + "\n"
        ...
        + " utilisateurs la liberté de modifier et de réutiliser le logiciel régi par cette"
        + " licence.\n"
        + "\n"
        + "L'exercice de cette liberté est assorti d'une obligation de remettre à la dispos"
        + "ition de la communauté les modifications apportées au code source du logiciel af"
        + "in de contribuer à son évolution.\n"
        + "\n"
        ...
        + "\n"
        + "Logiciel Modifié: désigne le Logiciel modifié par au moins une Contribution Inté"
        + "grée.\n"
        + "\n"
        ...
        + "\n"
        + "Contribution Intégrée: désigne l'ensemble des modifications, corrections, traduc"
        + "tions, adaptations et/ou nouvelles fonctionnalités intégrées dans le Code Source"
        + " par tout Contributeur.\n"
        + "\n"
        + "Module Lié: désigne un ensemble de fichiers sources y compris leur documentation"
        + " qui, sans modification du Code Source, permet de réaliser des fonctionnalités o"
        + "u services supplémentaires à ceux fournis par le Logiciel.\n"
        + "\n"
        ...
        + "\n"
        + "Le droit de modification comporte le droit de traduire, d'adapter, d'arranger ou"
        + " d'apporter toute autre modification au Logiciel et le droit de reproduire le lo"
        + "giciel en résultant. Il comprend en particulier le droit de créer un Logiciel Dé"
        + "rivé.\n"
        + "\n"
        + "Le Licencié est autorisé à apporter toute modification au Logiciel sous réserve "
        + "de mentionner, de façon explicite, son nom en tant qu'auteur de cette modificati"
        ...
        + "\n"
        + "Lorsque le Licencié apporte une Contribution Intégrée au Logiciel, les condition"
        + "s de distribution du Logiciel Modifié en résultant sont alors soumises à l'intég"
        + "ralité des dispositions du Contrat.\n"
        + "\n"
        + "Le Licencié est autorisé à distribuer le Logiciel Modifié sous forme de code sou"
        + "rce ou de code objet, à condition que cette distribution respecte les dispositio"
        + "ns du Contrat dans leur totalité et soit accompagnée:\n"
        + "\n"
        + "d'un exemplaire du Contrat,\n"
        + "\n"
        + "d'un avertissement relatif à la restriction de garantie et de responsabilité du "
        ...
        + "e Licencié permette un accès effectif à son code source complet pendant au moins"
        + " toute la durée de sa distribution du Logiciel Modifié, étant entendu que le coû"
        + "t additionnel d'acquisition du code source ne devra pas excéder le simple coût d"
        + "e transfert des données.\n"
        + "\n"
        + "5.3.3 DISTRIBUTION DU LOGICIEL DERIVE\n"
        + "\n"
        + "Lorsque le Licencié crée un Logiciel Dérivé, ce Logiciel Dérivé peut être distri"
        + "bué sous un contrat de licence autre que le présent Contrat à condition de respe"
        + "cter les obligations de mention des droits sur le Logiciel telles que définies à"
        + " l'article 6.4. Dans le cas où la création du Logiciel Dérivé a nécessité une mo"
        + "dification du Code Source le licencié s'engage à ce que:\n"
        + "\n"
        + "le Logiciel Modifié correspondant à cette modification soit régi par le présent "
        + "Contrat,\n"
        + "les Contributions Intégrées dont le Logiciel Modifié résulte soient clairement i"
        + "dentifiées et documentées,\n"
        + "le Licencié permette un accès effectif au code source du Logiciel Modifié, penda"
        + "nt au moins toute la durée de la distribution du Logiciel Dérivé, de telle sorte"
        + " que ces modifications puissent être reprises dans une version ultérieure du Log"
        + "iciel, étant entendu que le coût additionnel d'acquisition du code source du Log"
        + "iciel Modifié ne devra pas excéder le simple coût du transfert des données.\n"
        + "5.3.4 COMPATIBILITE AVEC LA LICENCE CeCILL\n"
        + "\n"
        + "Lorsqu'un Logiciel Modifié contient une Contribution Intégrée soumise au contrat"
        + " de licence CeCILL, ou lorsqu'un Logiciel Dérivé contient un Module Lié soumis a"
        + "u contrat de licence CeCILL, les stipulations prévues au troisième item de l'art"
        + "icle 6.4 sont facultatives.\n"
        + "\n"
        ...
        + "\n"
        + "Le Licencié qui a développé une Contribution Intégrée est titulaire sur celle-ci"
        + " des droits de propriété intellectuelle dans les conditions définies par la légi"
        + "slation applicable.\n"
        + "\n"
        + "6.3 SUR LES MODULES LIES\n"
        + "\n"
        + "Le Licencié qui a développé un Module Lié est titulaire sur celui-ci des droits "
        + "de propriété intellectuelle dans les conditions définies par la législation appl"
        + "icable et reste libre du choix du contrat régissant sa diffusion dans les condit"
        + "ions définies à l'article 5.3.3.\n"
        + "\n"
        ...
        + "facilement accessible notamment depuis l'interface de tout Logiciel Dérivé.\n"
