...
public class GPL implements Trigger {
    ...
    String[] blackList = {
        // this license text causes problems on detection of GPL
    ...
    final String
            ...
            // Affero
            idAGPL3_0 = "AGPL-3.0",
            titleAGPL3_0 = "GNU Affero General Public License v3.0",
            idALGPL3_0 = "ALGPL-3.0",
            titleALGPL3_0 = "GNU Affero Lesser General Public License v3.0";
    ...
    /**
     * Detects which kind of license we are referring to. When no specific
     * information is available, we can't make an assumption.
     ...
     */
    private Boolean detectLicenseVersion(final String text) {
...
//        // all good, proceed
//        return true;
//                //!text.contains("why-not-lgpl.html");
//    }
