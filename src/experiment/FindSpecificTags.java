...
//		displaySegments(source.getAllTags(HTMLElementName.META));
		
//                System.out.println("H2 Elements:");
		//displaySegments(source.getAllElements(HTMLElementName.META));
...
//                Source source=new Source(new URL(sourceUrlString));
//                List<Element> segments = source.getAllElements(HTMLElementName.META);
//                for (Element segment : segments) {
//                    String text = segment.toString().toLowerCase();
//                    if(text.contains("<meta http-equiv=")==false){
//                        continue;
//                    }
//                    // get specifically the time delay and URL
//                    String content = segment.getAttributeValue("content");
//                    // this can't be empty
//                    if(content == null){
//                        break;
//                    }
